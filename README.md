...
<p align="center"><img src="docs/tiles_dogs.jpg" width="520" alt="A sheet of the dog photos used as tiles"></p>
...
* **[cat](docs/credits-cat.md)**
* **[flower](docs/credits-flower.md)**
* the 1,000 bundled with the package — credits ship inside it, as `sakuhart/ATTRIBUTION.md`

## Licence

MIT — see [LICENSE](LICENSE). The photo packs are CC BY 2.0: if you publish a mosaic built from one,
ship the `ATTRIBUTION.md` inside its zip alongside it.
